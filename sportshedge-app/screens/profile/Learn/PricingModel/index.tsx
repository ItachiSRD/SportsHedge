...
type PricingModelScreenPropsT = StackScreenProps<ProfileStackListT, 'PricingModel'>;

const PricingModelScreen = ({ navigation}: PricingModelScreenPropsT) => {
  return (
    <BaseScreen>
...
export default PricingModelScreen