...
describe('UpdateOrdersService', () => {
  ...
  describe('Collect', () => {
    it('Has Partial', async () => {
      const output = service.getConvertedOrderIds(fulfilled, partial);
    ...
    it('Should not have null', async () => {
      ...
      const output = service.getConvertedOrderIds(fulfilled, null);
  ...
  describe('Extract', () => {
    it('Should work', () => {
      const output = service.getConvertedUserIds(orders);
      console.log(output);
    });
  });
  ...
  describe('Convert', () => {
    it('Should work', () => {
      const uniqueId = '2';
      const output = service.formatToTransaction(
        uniqueId,
        fulfilled,
        partial,
        [
